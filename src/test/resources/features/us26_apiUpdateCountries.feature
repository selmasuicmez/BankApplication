  ...
  Feature: US_26 System should allow to update countries using api end point
    Background:update all country
      Given use api end point "https://www.bank.com/api/tp-countries"
    @allCountry
    ...
    Scenario Outline: TC_02 update first,second and last countries 1 by 1
      And   user updates a country using api end point "https://www.bank.com/api/tp-countries"  "<name>" and its extension "<id>"
